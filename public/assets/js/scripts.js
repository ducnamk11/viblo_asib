...
(function () {
    ...
    $(document).ready(function () {
        ...
        $('.left-side-nav [data-toggle="tooltip"]').tooltip({
            template:
                '<div class="tooltip left-side-nav-tooltip" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>',
        });
        ...
        $("#left-nav-toggler").on("click", function (e) {
            ...
            $(
                ".left-side-nav .sidenav-second-level, .left-side-nav .sidenav-third-level"
            ).removeClass("show");
        });
        ...
        $(
            "body.fixed-nav .left-side-nav, body.fixed-nav .sidenav-toggler, body.fixed-nav .navbar-collapse"
